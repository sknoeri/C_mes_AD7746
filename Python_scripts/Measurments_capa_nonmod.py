...
# a2=np.mean(capa[72873:73163]-4003)
# b2=np.mean(capa[74158:74467]-4003)
# a3=np.mean(capa[78840:79175]-4003)
# b3=np.mean(capa[80177:80483]-4003)
# a4=np.mean(capa[83168:83641]-4003)
# b4=np.mean(capa[84524:84926]-4003)
## 30 Volts
...
three8=abs(c7/d7)
three9=abs(c8/d8)
zero=[zero1,zero2,zero3,zero4,zero5,zero6,zero7,zero8,zero9]
three=[three1,three2,three3,three4,three5,three6,three7,three8,three9]
ex=np.arange(1,len(zero)+1,1)
plt.figure()
plt.plot(ex,zero,'-o',label='Ratio 0V applied')
plt.plot(ex,three,'-o',label='Ratio 30V applied')
